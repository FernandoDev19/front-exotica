...
import { DialogService } from '../../../../shared/components/products/features/product-details/data-access/dialog.service';
...
export class BannersComponent implements OnInit {
  ...
  protected addProductToCart(product: Product) {
    ...
    const productInCart = this.isProductInCart.find(
  ...
  protected productInCart(productId: number) {
    return this.isProductInCart.find((item) => item.productId === productId)
      ?.isInCart;
  }
